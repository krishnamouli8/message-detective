...
export default function SignupPage() {
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-background p-4">
      <Card className="mx-auto max-w-sm w-full bg-mica">
        <CardHeader className="space-y-4 text-center">
          ...
          <CardDescription>
            Enter your information to get started with Email Detective
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid gap-4">
            <div className="grid gap-2">
                ...
                <Input id="full-name" placeholder="Sherlock Holmes" required />
            </div>
            <div className="grid gap-2">
